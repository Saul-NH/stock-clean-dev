            ...
            <div class="card border-info">
                ...
                <div class="card-body">
                    <form action="{{ route('productos.store')}}" method="post">
                        ...
                        <div class="form group">
                            <label class="h5" for="cantidad-producto">Cantidad en inventario</label>
                        ...
                        <div class="form group">
                            ...
                            <input name="precio_venta" class="form-control form-control-lg mb-3" id="precio-venta" type="number"  value="{{ old('precio_venta') }}" step="any" min="1" autocomplete="precio_venta" required placeholder="$">
                        </div>
